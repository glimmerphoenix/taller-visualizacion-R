...
de ese *dataset* y la organizació de sus valores.
:::
...
- Un *cuerpo* (en inglés *field*, a veces traducido como *campo*) en un dataset que contiene valores de atributos asociados
...
- Otro paquete muy conocido es `RColorBrewer`, muy popular en cartografía puesto que
